            ...
            <section className="mt-12 space-y-12">
              ...
              <div>
                ...
                <p className="mt-4 text-[#727272] text-sm sm:text-base text-justify leading-relaxed">
                  ...
                  contains a number of branch campuses from the top universities
              ...
              <div>
                ...
                <ul className="list-disc pl-6 mt-6 space-y-3 text-[#727272] text-sm sm:text-base">
                  <li>
                    ...
                    from the UK, the US, and Australia, including the University
                    of Birmingham, Heriot-Watt, Murdoch University, etc.
                  </li>
                  ...
                  <li>
                    ...
                    comparison to key Western study destinations, Dubai provides
                    you with a cheaper education and, subsequently, a more
                    affordable living experience.
                  </li>

                  <li>
                    <strong>Safe and Student-Focused:</strong> On an
                    international basis, Dubai is frequently cited as one of the
                    safest cities in the world, and has modern structures,
                    quality healthcare facilities, and welcoming locals who will
                    support you in experiencing an immediate life change to
                    studying abroad.
                  </li>

                  <li>
                    <strong>Flexible Visa & Residency Regulations:</strong>{" "}
                    Dubai’s student visa offers flexibility and allows students
                    to continue staying in the country after graduation if they
                    secure employment.
                  </li>

                  <li>
                    <strong>Opportunity to Bring Your Family:</strong> Here, you
                    do not have to leave your family behind, as a student, you
                    can also bring your spouse and kids by applying for
                  ...
                  <li>
                    <strong>Multiple Intakes:</strong> In Dubai, intakes happen
                    multiple times throughout the whole year, mainly in January,
                    May, June, July, and September months which provides
                    students with the ability to plan their admission timeframe
              ...
              <div>
                ...
                <ul className="list-disc pl-6 mt-4 space-y-4 text-[#727272] text-sm sm:text-base">
                  <li>
                    ...
                    55% in class 12 (in any stream) and also fulfill one English
                    language requirements. (A minimum IELTS band score of 5.5/ a
                    PTE score of 42 or above/Year 12 English Marks can be
                    considered as a waiver)
                  </li>

                  <li>
                    <strong>Postgraduate (PG):</strong> If you want to pursue a
                    postgraduate program, then you must have a minimum of 50-55%
                    in a Bachelor’s Degree and also fulfill any one English
                    language requirements. (a minimum IELTS band score of 6.0/ a
                    PTE score of 50 or above/ a Medium of Instruction (MOI)
                    letter/ by passing an Internal College English Test)
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <h4 className="text-lg font-semibold text-[#28535B]">
                  It varies based on the program level. Here is the approximate
              ...
              <div>
                ...
                <div className="mt-8 space-y-6 text-[#727272] text-sm sm:text-base leading-relaxed">
                  ...
                  <div>
                    <p className="font-semibold text-[#28535B]">
                      Step 3: Pay Visa Fees & Initiate Entry Permit Application
                    </p>
                    <p>
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      the GDRFA (General Directorate of Residency and Foreigners
                  ...
                  <div>
                    ...
                    <p>
                      Upon successful completion of the above steps, you will be
                      issued your Emirates ID and a 1-year renewable student
                      visa.
                    </p>
                  </div>
                </div>
              ...
              <div>
                ...
                <p className="mt-4 text-[#727272] text-sm sm:text-base leading-relaxed">
                  ...
                  journey remains easy and worry-free. Here are the reasons why
                ...
                <div className="mt-8 space-y-6 text-[#727272] text-sm sm:text-base leading-relaxed">
                  ...
                  <div>
                    ...
                    <p>
                      We have expertise in student visa processing for multiple
                      top destinations, including Dubai, the UK, and Australia,
                      so you can explore several international education
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      in Dubai, and our experienced team guides you through the
                      entire visa process clearly and systematically.
                    </p>
                  </div>
